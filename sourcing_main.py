...
ethnicity_src = spark.createDataFrame(pd.read_csv("https://raw.githubusercontent.com/yomiogunkayode/Dissertation/main/ethnicity_uk.csv"))
ethnicity_src.write.mode("overwrite").csv("/dissertation_data/input/static/ethnicity")

education_src = spark.createDataFrame(pd.read_csv("https://raw.githubusercontent.com/yomiogunkayode/Dissertation/main/Education_Level_England.csv"))
education_src.write.format("csv").mode('overwrite').save("/dissertation_data/input/static/education")

income_wealth_src = spark.createDataFrame(pd.read_csv("https://raw.githubusercontent.com/yomiogunkayode/Dissertation/main/Income_Wealth_UK.csv"))
income_wealth_src.write.format("csv").mode('overwrite').save("/dissertation_data/input/static/income")
...
lacode_src.write.format("csv").mode("overwrite").option("quote", "").option("delimiter", "~").save("/dissertation_data/input/static/la_code")
...
cases_age_region_src.write.format("csv").mode('overwrite').save("/dissertation_data/input/dynamic/covid/infections/england/age")
...
vaccin_first_src.write.format("csv").mode('overwrite').save("/dissertation_data/input/dynamic/covid/vaccinations/england/first_vac")
...
vaccin_second_src.write.format("csv").mode('overwrite').save("/dissertation_data/input/dynamic/covid/vaccinations/england/second_vac")
...
male_cases_src.write.format("csv").mode('overwrite').save("/dissertation_data/input/dynamic/covid/infections/england/male_case")
...
female_cases_src.write.format("csv").mode('overwrite').save("/dissertation_data/input/dynamic/covid/infections/england/female_case")
